...
<div id="content1">
	<div id="width">
        ...
        <tr height=40>
        <?php 
            $sql=Sqlquery("select * from article where id = '$file_id1'");
            $result=mysql_fetch_array($sql);
       ?> 
        	<td colspan=6 width=100><h3>Blog Articles</h3></td>
        </tr>
        <tr height=40>
...
<?php
       $sql="select count(*) from comment where fileid=".$result['id'];
				 $rs=Sqlquery($sql);
				 ...
				 $rsc=Sqlquery("select * from comment where fileid='$result[id]' order by id desc limit $offset,$pagesize");
				 if($rsc==false)
				 {
		     	 ?>
				...
				{
				 	while ($result = mysql_fetch_array($rsc))
			  		{
						?>
    <table class="table1">
    <tr height=40>
    ...
    <tr height=40>
			...
			{
			  echo "<a href=browse_article.php?page=1&file_id=".$file_id1.">Home</a>";
			  echo "&nbsp&nbsp";
			  echo "<a href=browse_article.php?page=".($page-1)."&file_id=".$file_id1.">Previous Page</a>";
			}
			...
			{
			  echo "&nbsp&nbsp";
			  echo "<a href=browse_article.php?page=".($page+1)."&file_id=".$file_id1.">Next Page</a>&nbsp;"; 
			  echo "&nbsp&nbsp";
			  echo "<a href=browse_article.php?page=".$page_count."&file_id=".$file_id1.">Last Page</a>";
			}
    ...
    <form name="myform" method="post" action="check_comment.php">
            <table class="table1">
                <tr height=40>
                    <td colspan="2"><h3>Add Comments</h3></td>
                </tr>
                <tr height=40>
                    <td colspan="2"><input name="htxt_fileid" type="hidden" value="<?php echo $_GET['file_id'];?>"></td>
                </tr>
                <tr>
                    <td width="140">Comment Content</td>
                    <td><textarea name="txt_content" cols="50" rows="8" id="txt_content" ></textarea></td>
                </tr>
                <tr height=40>
                    <td colspan=2 align="center"><input type="submit" value="Submit" onClick="return r_check();"><input type="reset" value="Reset"></td>
                </tr>
            </table>
    </form>
        </div>
