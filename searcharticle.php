...
<body>
	...
	if($_SESSION['level']==1)
	{
		...
		<li><a href="searcharticle.php">Articles Management</a></li>
        		...
        		<tr height=40>
            		...
            		<td colspan=3>
						<?php			 
							...
							{
								echo "<a href=searcharticle.php?page=1>Home</a>";
								echo "&nbsp&nbsp";
								echo "<a href=searcharticle.php?page=".$pre_page.">Previous Page</a>";
							}        
							if($page==$page_count)
							{
							...
							{
							  echo "&nbsp&nbsp";
							  echo "<a href=searcharticle.php?page=".$next_page.">Next Page</a>"; 
							  echo "&nbsp&nbsp";
							  echo "<a href=searcharticle.php?page=".$page_count.">Last Page</a>";
							}
					 }
               			?> 
            		</td>
