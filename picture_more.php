...
<div id="content">
	<div id="width">
        <div id="left"> 
        <br>
        <h3>Browse All Pictures Details</h3><br>
        ...
        <?php 
			 ...
			 $rs=Sqlquery("select * from picture order by id desc limit $offset,$pagesize");
			  while ($result = mysql_fetch_array($rs)){
		?>
	    <table width=500>
            <tr>
                <td colspan=4>
                <img src="images/<?php echo $result['pic']; ?>"  width="500" height="360" border="0"> 
                </td>
            </tr>
            <tr>                                                        
            ...
            <tr>
            	<td colspan=4 rowspan=10><?php echo $result['description'];?>
                <table>
                <tr>
                <td width=150>Page:<?php echo $page;?>/<?php echo $page_count;?>&nbsp;&nbsp;page record:<?php echo $numrows;?> Item&nbsp;</td>
            	<td>            
				<?php
                 }			 
                $pre_page=$page-1;
                ...
                if($page==1){
                  ...
                  echo "<a href=picture_more.php?page=1>Home</a>";
                  echo "&nbsp&nbsp";
                  echo "<a href=picture_more.php?page=".$pre_page.">Previous Page</a>";
                }
                ...
                if($page==$page_count){
                  ...
                  echo "&nbsp&nbsp";
                  echo "<a href=picture_more.php?page=".$next_page.">Next Page</a>"; 
                  echo "&nbsp&nbsp";
                  echo "<a href=picture_more.php?page=".$page_count.">Last Page</a>";
                }
                ?>       
                </tr>
                </table>
